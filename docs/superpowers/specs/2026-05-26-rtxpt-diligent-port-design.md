...
* The source code of RTXPT can be found at `D:/RTXPT-fork`. Its project memories and code-navigation tooling can be used to understand how the RTXPT rendering pipeline works.

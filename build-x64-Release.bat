...
call cmake -G "Visual Studio 17 2022" -B "%SolutionDir%build\x64\Release" -A x64 -DCMAKE_INSTALL_PREFIX="%SolutionDir%install\x64\Release" -DDILIGENT_BUILD_FX=TRUE -DDILIGENT_NO_RADIENT=ON -DDILIGENT_BUILD_FX_TESTS=OFF -DDILIGENT_BUILD_SAMPLES=TRUE -DDILIGENT_BUILD_TOOLS=TRUE -DDILIGENT_NO_WEBGPU=TRUE -DDILIGENT_NO_ARCHIVER=FALSE -DDILIGENT_BUILD_TESTS=TRUE -DDILIGENT_DEVELOPMENT=TRUE -DDILIGENT_NO_FORMAT_VALIDATION=FALSE -DDILIGENT_USE_SPIRV_TOOLCHAIN=TRUE
